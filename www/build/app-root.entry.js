...
import { S as SearchActions, s as store } from './SearchActions-c101bcb3.js';
...
const pokemonSearchReducer = (state = getInitialState(), action) => {
  switch (action.type) {
    case SearchActions.TEXT_CHANGED:
      return Object.assign(Object.assign({}, state), { searchTerm: action.payload.data.newText });
  }
  return state;
};
...
const logger = /*@__PURE__*/getDefaultExportFromCjs(reduxLogger);

const configureStore = (preloadState) => createStore(rootReducer, preloadState, applyMiddleware(thunk, logger));
...
let AppRoot = class {
  ...
  render() {
    return (h("div", null, h("header", null, h("h1", null, "Pok\u00E9mon Evolution Chains")), h("main", null, h("stencil-router", null, h("stencil-route-switch", { scrollTopOffset: 0 }, h("stencil-route", { url: "/", component: "app-home", exact: true }), h("stencil-route", { url: "/profile/:name", component: "app-profile" }))))));
  }
};
